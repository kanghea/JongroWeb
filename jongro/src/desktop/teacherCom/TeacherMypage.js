    ...
    return(<div className='flex'>
            ...
            <div className='ml-[280px] flex justify-center w-[1239.2px] h-[1239.2px]'> 
                ...
                <div className='w-full text-right'>
                    ...
                    <ul className='flex justify-between align-middle items-center h-10 mt-5'>
                        <li className='flex justify-center bg-slate-300 w-full mr-5 h-full text-center items-center'>1</li>
                        <li className='flex justify-center bg-slate-300 w-full mr-5 h-full items-center'>2</li>
